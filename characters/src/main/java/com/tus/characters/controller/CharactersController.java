...
public class CharactersController {
	...
	public ResponseEntity<ResponseDto> deleteCharacter(@PathVariable Long characterId, @RequestParam Long userId) {
	 ...
	 * 
	 * @PutMapping("/{characterId}") public ResponseEntity<ResponseDto>
	 * updateCharacter(
	 * 
	 ...
	 * ResponseDto(CharacterConstants.STATUS_200,"Character updated successfully"));
	 * }
	 */
	...
	@GetMapping("/page")
	public ResponseEntity<Map<String, Object>> getCharactersPage(@RequestParam(defaultValue = "0") int page,
			@RequestParam(defaultValue = "5") int size, @RequestParam(defaultValue = "characterId") String sortBy,
